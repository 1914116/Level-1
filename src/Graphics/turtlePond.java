...
public class turtlePond implements KeyEventDispatcher {
	...
	void setup() {
		...
		JOptionPane.showMessageDialog(null, "Move turtle with the arrow keys to find the hidden cookie.\nYou'll get warmer the closer you get.\n\nHurry or she'll die of hunger!");
...
if(getTimeElapsed() >= 20){
	JOptionPane.showMessageDialog(null, "The Turtle is Dead because of you");
}
...
if(wasHereBefore(tortoiseLocationX, tortoiseLocationY)){
	JOptionPane.showMessageDialog(null, "You're terrible at this game.");
